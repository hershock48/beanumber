  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data?.code === 'number_claimed') {
        setState('error');
        setErrorMessage(
          `#${shirtNumber} is already linked to a different email. If that could be you, try the email you used when you got the shirt. Stuck? Email Kevin@beanumber.org and I'll sort it out.`
        );
        return;
      }
      setState('sent');
