...
const shirts: Shirt[] = [
  ...
  },
  {
    ...
    price: 25,
    description: 'Small # mark on the front, "Thank you." in large Lora serif across the back. It\'s the quietest shirt in the collection and probably the one that starts the most conversations.',
    Front: SharedFront,
    Back: ThankYouBack,
    badge: 'Faith',
    specs: 'S – 2XL · Unisex · Heavyweight cotton',
  },
  {
    ...
    price: 25,
    description: 'Small # mark on the front, "Do Not Fear." in large Lora serif stacked across the back. Some people wear it because they need the reminder themselves. Other people read it and realize they needed it too.',
    Front: SharedFront,
    Back: DoNotFearBack,
    badge: 'Faith',
    specs: 'S – 2XL · Unisex · Heavyweight cotton',
  },
  {
    ...
    price: 25,
    description: 'Small # mark on the front, "Peace / maker." stacked in large Lora serif across the back. This one is for the person who builds peace instead of just talking about it, which is really what the whole organization is about.',
    Front: SharedFront,
    Back: PeacemakerBack,
    badge: 'Faith',
    specs: 'S – 2XL · Unisex · Heavyweight cotton',
