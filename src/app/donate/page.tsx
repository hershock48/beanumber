...
export const metadata: Metadata = {
  ...
  description:
    'Your gift funds schools, clinics, vocational training, and trauma recovery in Northern Uganda. 96.7% goes directly to programs.',
  openGraph: {
    title: 'Donate | Be A Number',
    description:
      'Your gift funds schools, clinics, vocational training, and trauma recovery in Northern Uganda. 96.7% goes directly to programs.',
        ...
        <section className="pt-16 pb-8 px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-[#777] max-w-2xl mx-auto leading-relaxed">
              ...
              trades. 96.7% of every dollar reaches programs on the ground.
            </p>
          </div>
        </section>
