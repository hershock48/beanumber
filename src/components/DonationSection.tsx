    ...
    <section id="donate" className="py-16 md:py-24 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-gray-900 text-white p-6 sm:p-8 md:p-12 rounded-lg">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Join 100+ Donors Changing Lives</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <button
              ...
              disabled={isLoading}
              className="px-8 py-4 bg-white text-gray-900 rounded-md hover:bg-gray-100 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isLoading && (
